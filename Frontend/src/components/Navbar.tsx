      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center">
          <div className="flex gap-x-[36px]">
            <p className="text-base font-semibold text-[#04111D]">Explore</p>
            <p className="text-base font-semibold text-[#04111D]">Stats</p>
            <p className="text-base font-semibold text-[#04111D]">Create</p>
          </div>
